...
const int EID_O_CERTIFICATE_FOLDER	 = 2;
...
#else
EID_API int WINAPI EidSetOption(int nOptionID, uintptr_t nOptionValue);
#endif
...
EID_API int WINAPI EidVerifySignature(UINT_PTR nSignatureID);
