...
public:
    ...
    static CollapsibleSection* build(const QString& title, const LibreSCRS::Plugin::CardFieldGroup& group,
    ...
    static void highlightExpiredDates(CollapsibleSection* section, const LibreSCRS::Plugin::CardFieldGroup& group,
